    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            try {
                ...
                const response = await fetch(`http://52.172.222.95:8000/stocktracker/?stock_picker=AAPL&stock_picker=GOOGL&stock_picker=AMZN&stock_picker=MSFT&stock_picker=TSLA&stock_picker=NVDA&stock_picker=META&stock_picker=NFLX`, {
                    method: "GET",
